...
public class VCLOperationImpl extends ASTWrapperPsiElement implements VCLOperation {
  ...
  public VCLOperationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<VCLOperationInternal> getOperationInternalList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VCLOperationInternal.class);
  }
