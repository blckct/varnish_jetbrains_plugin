...
public class VCLAclImpl extends ASTWrapperPsiElement implements VCLAcl {

  public VCLAclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VCLAclEntry getAclEntry() {
    return findChildByClass(VCLAclEntry.class);
  }
