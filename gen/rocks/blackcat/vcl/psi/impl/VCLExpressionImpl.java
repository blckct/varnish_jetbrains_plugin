...
public class VCLExpressionImpl extends ASTWrapperPsiElement implements VCLExpression {
  ...
  public VCLExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<VCLExpression> getExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VCLExpression.class);
  }
