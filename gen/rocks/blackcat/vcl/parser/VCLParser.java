...
public class VCLParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // F_CALL | SET | UNSET | CALL | PURGE | NEW  | ERROR | RETURN | SYNTHETIC
  ...
  /* ********************************************************** */
  // (COMPOUND | IF_STATEMENT | INLINE_C | ACTION ';' ) *
